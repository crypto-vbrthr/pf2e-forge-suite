...
**Monstrous Afflictions** is a content add-on for **Affliction Forge** containing **32 original creature-themed afflictions from levels 0 through 20**, designed specifically for monsters, supernatural beings, and other dangerous inhabitants of a Pathfinder 2E world.

The collection includes **16 diseases, 8 poisons, and 8 curses**, ranging from relatively mundane parasites and animal-borne infections to supernatural corruption, fiendish maladies, draconic toxins, extraplanar curses, and truly dangerous high-level afflictions. Their sources include **animals, beasts, fungi, plants, oozes, undead, dragons, fey, spirits, aberrations, fiends, celestials, constructs, elementals, and monitors**.

Each affliction uses Affliction Forge's staged progression system and can combine **saving throws, onset periods, stage durations, damage, persistent damage, conditions, restrictions, virulent or stubborn progression, and other supported mechanical effects**.

Monstrous Afflictions is particularly designed to work with **Creature Forge**. Every entry includes standardized semantic tags describing its **creature type, family, habitat, theme, origin, and delivery method**, allowing Creature Forge to discover and select suitable afflictions automatically without requiring a hard dependency between the two modules.

Natural venoms delivered through **bites, stings, claws, or similar creature abilities** remain creature afflictions rather than being treated as weapon coatings, preserving the distinction between a monster's innate poison and Affliction Forge's charge-based injury-poison system.

All entries are available in **English and German** and are provided through a managed, read-only Affliction Forge library.

All afflictions contained in **Monstrous Afflictions** are original homebrew content created specifically for the Forge Suite.
...
The collection includes **13 curses, 11 diseases, and 8 poisons**, with strong themes of **dreams, mental corruption, shadows, parasites, mutation, necrotic influence, strange fungi, and supernatural contamination**. Its afflictions are particularly suited to aberrations, spirits, fey, undead, planar creatures, parasites, and other entities touched by unsettling occult forces.

Occult Horrors makes extensive use of Affliction Forge's advanced mechanics, including **stubborn and virulent progression, healing restrictions, condition locks, blocked speech, concentration gates, persistent damage, staged conditions, and other escalating consequences**. Afflictions can unfold over anything from individual combat rounds to hours or several days, allowing them to serve as immediate threats or lingering campaign complications.

Natural or supernatural venoms delivered through **bites, stings, and creature abilities** remain innate creature afflictions and do not use Affliction Forge's weapon-coating charge system.

Every entry includes standardized semantic tags describing its **creature associations, families, habitats, themes, origins, and delivery methods**. This allows **Creature Forge** to discover and select suitable occult afflictions automatically without requiring a direct dependency between the two modules.

All entries are available in **English and German** and are distributed through a managed, read-only Affliction Forge library.

All afflictions contained in **Occult Horrors** are original homebrew content created specifically for the Forge Suite.
...
**Plagues & Pestilence** is a content add-on for **Affliction Forge** containing **28 original staged diseases from levels 0 through 20**, designed to bring sickness, outbreaks, parasites, environmental infections, and supernatural epidemics into Pathfinder 2E campaigns.

The collection ranges from relatively mundane illnesses spread by **animals, contaminated water, insects, wounds, spores, and harsh environments** to increasingly dangerous fungal, parasitic, primal, planar, and supernatural diseases. Individual afflictions are associated with suitable habitats and sources, making them useful both as creature abilities and as hazards encountered naturally during exploration and adventure.

Diseases use Affliction Forge's full staged progression system and can feature **onset periods, hourly or daily stages, Fortitude and Will saves, conditions, direct and periodic damage, healing restrictions, speech restrictions, pre-action checks, virulent progression, and lethal final stages**. Some diseases develop slowly over several days, while others can become dangerous much more rapidly.

Every entry includes standardized semantic tags describing its **creature associations, families, habitats, themes, origins, and methods of transmission**. This allows integrations such as **Creature Forge** to search for and automatically select diseases appropriate to a particular creature, environment, or concept without requiring a direct dependency between the modules.

All entries are available in **English and German** and are distributed through a managed, read-only Affliction Forge library. Copies placed in the normal Affliction Forge world library remain fully editable for individual campaigns.

All diseases contained in **Plagues & Pestilence** are original homebrew content created specifically for the Forge Suite.
...
**Planar Contagions** is a content add-on for **Affliction Forge** containing **32 original extraplanar afflictions from levels 0 through 20**, designed for creatures, locations, and adventures touched by realities beyond the Material Plane.

The collection includes **12 diseases, 9 poisons, and 11 curses** originating from elemental forces, strange planar environments, supernatural corruption, extraplanar creatures, and metaphysical phenomena. Afflictions range from elemental infections and otherworldly venoms to curses that distort thought, time, fate, life force, and the relationship between body and soul.

Planar Contagions makes extensive use of Affliction Forge's advanced mechanics, including **stubborn and virulent progression, persistent damage, healing restrictions, blocked speech, condition locks, concentration gates, staged conditions, and a high-level death effect**. Afflictions can progress over individual combat rounds, hours, or several days, allowing them to function as immediate creature abilities as well as lingering consequences of planar exploration.

Every entry includes standardized semantic tags describing its **creature associations, families, habitats, themes, origins, and delivery methods**. Strong `planar` habitat and origin tagging allows **Creature Forge** to discover suitable afflictions automatically for celestials, fiends, fey, monitors, elementals, spirits, undead, aberrations, constructs, dragons, and many other creatures.

Natural and supernatural creature poisons delivered through **bites, stings, contact, spores, or innate abilities** remain creature afflictions and do not use Affliction Forge's charge-based weapon injury-poison system.

All entries are available in **English and German** and are distributed through a managed, read-only Affliction Forge library.

All afflictions contained in **Planar Contagions** are original homebrew content created specifically for the Forge Suite.
...
The collection includes **12 diseases, 8 poisons, and 12 curses**. Its themes range from contaminated water, vermin, industrial pollution, and criminal toxins to haunted districts, occult conspiracies, supernatural corruption, and curses born from the secrets cities accumulate over centuries.

Urban Horrors makes extensive use of Affliction Forge's advanced mechanics, including **persistent damage, virulent and stubborn progression, concentration gates, blocked speech, condition locks, healing restrictions, staged conditions, and a level-20 death effect**. Six entries are true **weapon injury poisons** and integrate directly with Affliction Forge's existing coating and charge workflow.

Every affliction carries the `urban` habitat tag together with more specific semantic information describing its **creature associations, families, themes, origins, and delivery methods**. This allows **Creature Forge** to automatically discover appropriate afflictions for humanoids, undead, spirits, fungi, oozes, aberrations, constructs, celestials, fiends, fey, and other creatures associated with urban environments.

More specific creature matching includes families such as **rats, snakes, fish, and parasites**, making the library useful not only for humanoid intrigue and city hazards but also for monsters that thrive beneath, between, and behind the walls of civilization.

All entries are available in **English and German** and are distributed through a managed, read-only Affliction Forge library.

All afflictions contained in **Urban Horrors** are original homebrew content created specifically for the Forge Suite.
...
**Venoms & Toxins** is a content add-on for **Affliction Forge** containing 32 original staged poisons from levels 0 through 20, covering both natural creature venoms and deliberately manufactured toxins.

The collection includes venoms from spiders, snakes, scorpions, fish, insects, amphibians, beasts, and planar predators, alongside alchemical contact poisons, ingested toxins, inhaled poisons, and weapon coatings. Seven entries are dedicated injury poisons and integrate directly with Affliction Forge's charge-aware weapon and attack workflow.

Its afflictions use the full staged progression system of **Affliction Forge** and can feature Fortitude or selected Will saves, onset periods, maximum durations, poison damage, persistent damage, conditions, virulent progression, and even a high-level death effect.

A deliberate distinction is maintained between innate creature venoms and consumable weapon poisons. Venoms delivered naturally through bites, stings, or similar attacks remain creature afflictions, while specifically formulated alchemical coatings use **Affliction Forge's** injury-poison system with charges and combat-triggered application.

Every entry includes standardized semantic tags describing its creature associations, families, habitats, themes, origins, and delivery methods. This allows **Creature Forge** and other modules to discover and select appropriate poisons without depending on **Venoms & Toxins** directly.

All entries are available in English and German and are distributed through a managed, read-only Affliction Forge library. Copies transferred into the normal **Affliction Forge** world library remain independent and editable.

All poisons contained in **Venoms & Toxins** are original homebrew content created specifically for the **Forge Suite**.
...
**Item Forge** is a reusable item-generation engine for Pathfinder 2E in Foundry VTT, designed to create, select, and compose **level-appropriate equipment, magic items, valuables, and other inventory objects** while preserving PF2e's native item structures wherever possible.

Game Masters can generate items by **category, level or level range, source, theme, and generation policy**. Item Forge can select existing equipment directly from configured compendia or construct new items using reviewed generation profiles. Supported categories include ordinary **weapons, armor, shields, scrolls, and equipment**, as well as specialized magic items such as **wands, staves, spellhearts, grimoires, apex items, worn and held magic items, specific magic weapons and armor, specific shields, and accessory runes**.

Generated equipment can incorporate appropriate **fundamental and property runes**, while spell-bearing items use actual spells from the selected PF2e sources and respect valid spell ranks and meaningful heightening. More complex magic items use coherent profiles rather than assembling unrelated effects at random, helping generated results remain thematically and mechanically consistent.

Item Forge also contains an extensive **treasure generator** capable of creating individual valuables from dozens of treasure types, materials, motifs, conditions, craftsmanship levels, styles, and reusable components. Generated treasures include detailed descriptions and transparent valuation metadata, allowing them to function as believable objects rather than anonymous amounts of gold.

A configurable **Compendium Source Policy** lets the Game Master decide which PF2e system or additional content sources may contribute published items, spells, equipment, and other generation components. Existing PF2e items are preserved with their native rules and automation, while generated content clearly distinguishes native automation from abilities represented through structured metadata and readable rules text.

The integrated **Item Forge Editor** provides generation controls, previews, rerolls, source selection, and item descriptions before anything is created in the world. Deterministic seeded generation also makes results reproducible when needed.

Item Forge exposes a stable **public API and extension registries**, allowing other Forge modules and add-ons to use the same generation engine, add new item categories, profiles, and generators, or request items without duplicating the underlying logic.

Item Forge is available in **English and German**.

**Item Forge: Martial Consequences** can be found here: https://github.com/crypto-vbrthr/pf2e-item-forge
